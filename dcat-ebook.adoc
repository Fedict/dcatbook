...
Vocabularies and ontologies do not magically turn RDF data into pools of knowledge.
It requires special tools to 
...
Even worse, reasoners may add statements and may come to logical but surprising results, 
