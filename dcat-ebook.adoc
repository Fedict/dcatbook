...
which is not surprisingly since RDF was developped within the W3C consortium, 
...
developped and supported by Facebook to share info in a social media context. 
